...
exports.generateTypeDeclarations = exports.getGenerateTypeDeclarationHandler = void 0;
const node_fs_1 = __importDefault(require("node:fs"));
const node_path_1 = __importDefault(require("node:path"));
const generate_1 = require("./generate");
const _ctx_1 = require("../../_ctx");
const matchers_1 = require("../matchers");
function getGenerateTypeDeclarationHandler(outputDir) {
    ...
    return async function callback({ filePath, type }) {
        ...
        if (shouldRegenerate) {
            (0, exports.generateTypeDeclarations)(outputDir);
        }
    };
}
exports.getGenerateTypeDeclarationHandler = getGenerateTypeDeclarationHandler;
exports.generateTypeDeclarations = throttle((outputDir) => {
